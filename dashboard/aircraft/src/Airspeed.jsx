...
export default function Airspeed() {
  ...
  // Dummy data
  const dummyHistory = [
    { time: "10:00:00", speed: 0 },
    { time: "10:00:10", speed: 0 },
    { time: "10:00:20", speed: 0 },
    { time: "10:00:30", speed: 0 },
    { time: "10:00:40", speed: 0 },
  ];
      ...
      <Container maxWidth="xl" sx={{ py: { xs: 2, md: 4 } }}>
        <Box mb={2}>
          ...
          <Typography color="text.secondary">
            Pantauan Kecepatan Udara secara Real-Time. (Sistem belum terintegrasi).
          </Typography>
        </Box>
                    ...
                    <Box display="flex" justifyContent="space-between">
                      <Box>
                        ...
                        <Typography variant="h4" fontWeight={700} color="primary">
                          0 <Typography component="span" variant="h6" color="text.secondary">knots</Typography>
                        </Typography>
                      </Box>
